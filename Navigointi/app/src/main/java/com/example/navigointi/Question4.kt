...
import com.example.navigointi.databinding.FragmentQuestion4Binding

// TODO: Rename parameter arguments, choose names that match
// the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
private const val ARG_PARAM1 = "UserAnswerQ3"
private const val ARG_PARAM2 = "param2"

/**
 * A simple [Fragment] subclass.
 * Use the [Question4.newInstance] factory method to
        ...
        binding.buttonSecond4.setOnClickListener {
            ...
            if (selection > -1) {
                findNavController().navigate(
                    Question4Directions.actionQuestion4ToQuestion5(ans.toString()
                    )
                )
