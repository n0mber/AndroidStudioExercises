...
import com.example.navigointi.databinding.FragmentQuestion5Binding

// TODO: Rename parameter arguments, choose names that match
// the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
private const val ARG_PARAM1 = "UserAnswerQ4"
private const val ARG_PARAM2 = "param2"

/**
 * A simple [Fragment] subclass.
 * Use the [Question5.newInstance] factory method to
        ...
        binding.buttonSecond5.setOnClickListener {
            ...
            if (selection > -1) {
                findNavController().navigate(
                    Question5Directions.actionQuestion5ToResult(ans.toString()
                    )
                )
            }
        }
